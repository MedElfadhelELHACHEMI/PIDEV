 ...
 * @author Sameh
 */
public class ChoixCoursEpFinalController implements Initializable {
  @FXML
          ...
          if (type.equals("Objectifs")){
            for(int i=0;i<list.size();i++){
               ...
               String nameBadge=serviceApprenant.getNameBadge(list.get(i),CurrentUser.getId());
                    System.out.println("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"+type);
...
//                + "    -fx-border-width: 2px;\n"
           ...
           Pane p=new Pane();
            ...
            public void handle(ActionEvent event) {
                ...
                try {  
                 if (type.equals("Objectifs")){
                      FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/fxml/ChapitreCoursTermfxml.fxml"));
                 
                 
               AnchorPane anchorPane = (AnchorPane) fxmlLoader.load();
              
                ChapitreCoursTermfxmlController controller = fxmlLoader.<ChapitreCoursTermfxmlController>getController();

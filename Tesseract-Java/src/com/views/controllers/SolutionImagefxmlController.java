 ...
 * @author Sameh
 */
public class SolutionImagefxmlController implements Initializable {
 @FXML
...
private List<HistoriqueQuestion> listeRep;
    ...
    public void setId_question(int id_question) {
      try {
          ...
          repeterButton.setVisible(false);
...
//              }});
   ...
   @FXML
      void fermerAction(ActionEvent event) throws IOException {
       ...
       @FXML
      void repeterAction(ActionEvent event) throws IOException {
